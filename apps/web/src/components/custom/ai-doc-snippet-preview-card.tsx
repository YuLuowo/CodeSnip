...
export function AiDocSnippetPreviewCard({ snippet }: AiDocSnippetPreviewCardProps) {
    ...
    return (
        <Card className="hover:shadow-lg transition-shadow flex flex-col gap-2 py-0">
            <CardHeader className="p-4 pb-0">
                ...
                <CardDescription className="text-xs text-muted-foreground wrap-break-word line-clamp-3">
                    {snippet.desc && (
                        <p>{snippet.desc}</p>
                    )}
                </CardDescription>
